...
def argon_delay(block_size):
	...
	embedding_dimension = raw_input("What embedding dimension would you like to use? ")
	...
	#settings = Settings(gamma_file_name, embedding_dimension = 
